...
import ProjectModal from "../../../admin/projects/components/project/ProjectModal";
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <span className="text-sm text-text/60">{t("show")}</span>
            <CustomDropdown
            ...
            />
            <span className="text-sm text-text/60">{t("entries")}</span>
          </div>
        </div>
